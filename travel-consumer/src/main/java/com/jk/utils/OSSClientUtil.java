...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAI4FuGcVjk2836g3MuB5cL";
    private String accessKeySecret = "tLYnjW36TECfByykPxVyJIaz3ViXFO";
    // 空间
    private String bucketName = "kehousi";
    // 文件存储目录
    private String filedir = "lvyou/";
